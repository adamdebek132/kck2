...
public class MazeView extends View {
    ...
    private class UpdateViewRunnable implements Runnable {
        ...
        public void run() {
            ...
            Log.d("msg", "RX: " + pitch);
            Log.d("msg", "ori: " + orientationData.getOrientation());
            Log.d("msg", "start: " + orientationData.getStartOrientation());
    ...
    private static final long DELAY_TIME_MILLIS = 250L;
    ...
    private  static int COLS = 5, ROWS = 10;
    ...
    private  void createMaze(){
        ...
        updateViewRunnable.x = hMargin + (player.col + 0.5f)*cellSize;
        updateViewRunnable.y = vMargin + (player.row + 0.5f)*cellSize;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(((height-ROWS*cellSize)/2) < 0)
            cellSize = height/(ROWS+1);
        if(((width-COLS*cellSize)/2) < 0)
            cellSize = width/(COLS+1);
